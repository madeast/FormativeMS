...
public class MSPanel extends JPanel
{
	...
	public MSPanel(MSController baseController)
	{
		...
		baseLayout.putConstraint(SpringLayout.NORTH, majorTextField, 111, SpringLayout.NORTH, this);
		yearTextField = new JTextField("");
		baseLayout.putConstraint(SpringLayout.WEST, yearTextField, 221, SpringLayout.WEST, this);
		baseLayout.putConstraint(SpringLayout.EAST, majorTextField, -27, SpringLayout.WEST, yearTextField);
		baseLayout.putConstraint(SpringLayout.NORTH, yearTextField, 0, SpringLayout.NORTH, majorTextField);
		baseLayout.putConstraint(SpringLayout.SOUTH, yearTextField, -93, SpringLayout.SOUTH, this);
		...
		baseLayout.putConstraint(SpringLayout.NORTH, yearTextLabel, 62, SpringLayout.SOUTH, titleLabel);
		baseLayout.putConstraint(SpringLayout.SOUTH, yearTextLabel, -6, SpringLayout.NORTH, yearTextField);
		baseLayout.putConstraint(SpringLayout.EAST, majorTextLabel, -59, SpringLayout.WEST, yearTextLabel);
		baseLayout.putConstraint(SpringLayout.WEST, yearTextLabel, 0, SpringLayout.WEST, yearTextField);
		convertButton = new JButton("Decode.");
		baseLayout.putConstraint(SpringLayout.SOUTH, majorTextField, -60, SpringLayout.NORTH, convertButton);
		...
		baseLayout.putConstraint(SpringLayout.WEST, majorTextField, 17, SpringLayout.EAST, cCheckBox);
		...
		baseLayout.putConstraint(SpringLayout.EAST, yearTextField, -25, SpringLayout.WEST, oneCheckBox);
